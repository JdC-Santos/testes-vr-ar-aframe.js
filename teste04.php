  ...
  <body>
    <a-scene>
      <a-assets>
        ...
        <img id="pin" src="https://paulo-freire-vr-ra-o0jdc0o.c9users.io/imgs/bloco-mario.png" crossOrigin="true">
      </a-assets>

      <a-entity id="environment" environment="preset: forest; fog: false" shadow="cast: true; receive: true"></a-entity>
      <!-- Meshes. -->
      <a-entity position="0 0 -8">
        ...
        <a-box id="box" mixin="interactable" position="1 2 -1" width="5" height="4" color="orange"></a-box>

        <!-- Models. -->
        <a-entity mixin="interactable" class="boxClass" geometry="primitive: box" material="src: #crateImg" position="3 4 0"></a-entity>
        <a-entity mixin="interactable" class="boxClass" geometry="primitive: box" material="src: #pin" position="0 2 2"></a-entity>
